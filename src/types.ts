...
export interface BatchAlgoOrderResultItem {
  instId: string;
  algoId: string;
  clOrdId: string;
  sCode: string;
...
export interface BatchAmendAlgoResultItem {
  instId: string;
  algoId: string;
  sCode: string;
  sMsg: string;
...
export interface OKXClient {
  ...
  attachAlgoOrdersBatch(orders: AlgoOrderParams[]): Promise<BatchAlgoOrderResultItem[]>;
  amendAlgoOrder(params: AmendAlgoOrderParams): Promise<{ success: boolean; sCode: string; sMsg: string }>;
  amendAlgoOrdersBatch(orders: AmendAlgoOrderParams[]): Promise<BatchAmendAlgoResultItem[]>;
